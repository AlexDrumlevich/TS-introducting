...
function shiftCipher2(str, shift = 1) {
    return cipherDecipher(str, shift, mapperCipher);
}
function shiftDecipher2(str, shift = 1) {
...
function testCipherDecipher(data, testName) {
    ...
    const funForTest = testName === "cipherTest" ? shiftCipher2 : shiftDecipher2;
...
//# sourceMappingURL=appOopBased.js.map